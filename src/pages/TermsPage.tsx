      ...
      <div className="mx-auto max-w-4xl px-6 py-14">
        ...
        <div className="mt-10 space-y-8 text-sm leading-8 text-gray-700">
          ...
          <section>
            ...
            <p>用户购买或获得的额度用于提交改写任务。付费套餐是单次购买固定增加所选套餐额度，不自动续费。每次购买对应 30 天有效期；有效期内再次购买将在当前剩余有效期后叠加 30 天，已到期后再次购买则从付款时间重新计算 30 天。到期后未使用额度清零并恢复免费套餐。若任务处理失败，系统按规则自动退还额度。支付、退款或异常订单以平台实际记录为准。</p>
          </section>
          <section>
