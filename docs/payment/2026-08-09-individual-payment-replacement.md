# PaperFix 无公司主体支付替代调研与迁移建议（部分结论已废止）

**调研日期：2026-08-09**  
**适用现状：** 中国大陆个人开发者、没有公司或个体工商户营业执照；PaperFix 销售 30 天一次性套餐；原“巴巴博弈”EPAY 通道已停止服务。  
**本次范围：** 只读审计、方案调研和迁移边界设计。本文没有修改生产支付代码、数据库、环境变量，也没有部署。

## 0. 2026-08-10 决策修订（当前有效）

- 用户已确认爱发电的订阅/会员商品结构不符合 PaperFix 的 30 天一次性套餐，因此**爱发电路线已排除，不再推荐或实施**。
- 下方 2026-08-09 调研中所有“转爱发电”“最快备用方案”“阶段 2B”及品牌专用接入建议均为**已失效历史记录**，不得作为开发或上线依据。
- 一次性兑换码能力继续保留，但必须保持 provider-neutral：默认 `source=manual`，只有未来某个渠道明确支持个人卖家、一次性付款、逐单发放唯一兑换码和可核对退款时，才单独评估接入。
- 在找到并验证这样的渠道前，在线付费入口继续关闭；不得用订阅商品伪装一次性套餐，也不得恢复个人免签或收款码监听。

<details>
<summary>展开已废止的 2026-08-09 历史调研（仅用于决策追溯，不得实施）</summary>
